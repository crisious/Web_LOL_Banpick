...
```bash
npm test                 # 모든 테스트 일괄 실행 (test-artifacts/run-tests.mjs · 총 288건)
...
npm run smoke:external:readonly -- https://your-demo-url.example  # 외부 HTTPS URL + 저장 샘플 19개 기준 read-only smoke
```
