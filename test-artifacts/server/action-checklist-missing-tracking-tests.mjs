// server.js buildAnalysis actionChecklist missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_ACTION_MISSING", queueLabel: "RANKED_SOLO" },
...
const result = await buildAnalysis(normalizedFixture(), "sample-action-missing");
