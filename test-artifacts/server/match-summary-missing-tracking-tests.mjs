// server.js buildAnalysis matchSummary missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_MATCH_SUMMARY_MISSING", queueLabel: "RANKED_SOLO" },
    playerContext: { riotId: "Summary#KR1", participantId: 1 },
    timelineEvents: [],
    phaseContext: {},
    playerStats: {},
    teamContext: {},
...
const result = await buildAnalysis(normalizedFixture(), "sample-match-summary-missing");
