// server.js buildAnalysis evidenceIndex violation tracking regression tests
...
const buildAnalysis = new Function("state", `
  ...
  function buildEvidenceIndex() {
    state.evidenceRepairCalls += 1;
    return [{ eventId: "evt_001", summary: "repaired evidence" }];
  }
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_EVIDENCE_SHAPE", queueLabel: "RANKED_SOLO" },
    playerContext: { riotId: "Evidence#KR1", participantId: 1 },
    timelineEvents: [],
    phaseContext: {},
    playerStats: {},
    teamContext: {},
...
const result = await buildAnalysis(normalizedFixture(), "sample-evidence-shape");
