// server.js buildAnalysis strengths missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_STRENGTHS_MISSING", queueLabel: "RANKED_SOLO" },
...
const result = await buildAnalysis(normalizedFixture(), "sample-strengths-missing");
