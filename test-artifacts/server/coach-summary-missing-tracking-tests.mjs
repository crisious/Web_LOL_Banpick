// server.js buildAnalysis coachSummary missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_COACH_SUMMARY_MISSING", queueLabel: "RANKED_SOLO" },
    playerContext: { riotId: "Coach#KR1", participantId: 1 },
    timelineEvents: [],
    phaseContext: {},
    playerStats: {},
    teamContext: {},
...
const result = await buildAnalysis(normalizedFixture(), "sample-coach-summary-missing");
