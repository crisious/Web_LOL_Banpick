// server.js buildAnalysis teamfightPhaseAnalysis missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_TF_MISSING", queueLabel: "RANKED_SOLO" },
    playerContext: { riotId: "Teamfight#KR1", participantId: 1 },
    timelineEvents: [],
    phaseContext: {},
    playerStats: {},
    teamContext: {},
...
const result = await buildAnalysis(normalizedFixture(), "sample-teamfight-missing");
