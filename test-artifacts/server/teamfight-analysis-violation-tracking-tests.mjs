// server.js buildAnalysis teamfightPhaseAnalysis violation tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_TF", queueLabel: "RANKED_SOLO" },
...
const result = await buildAnalysis(normalizedFixture(), "sample-teamfight");
