// server.js buildAnalysis weaknesses missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_WEAKNESSES_MISSING", queueLabel: "RANKED_SOLO" },
...
const result = await buildAnalysis(normalizedFixture(), "sample-weaknesses-missing");
