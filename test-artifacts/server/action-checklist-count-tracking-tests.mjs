// server.js buildAnalysis actionChecklist count tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_ACTION_COUNT", queueLabel: "RANKED_SOLO" },
...
const result = await buildAnalysis(normalizedFixture(), "sample-action-count");
