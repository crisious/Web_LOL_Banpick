// server.js buildAnalysis phaseSummaries missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_PHASE_SUMMARIES_MISSING", queueLabel: "RANKED_SOLO" },
...
const result = await buildAnalysis(normalizedFixture(), "sample-phase-summaries-missing");
