// server.js buildAnalysis keyMoments missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_KEY_MOMENTS_MISSING", queueLabel: "RANKED_SOLO" },
...
const result = await buildAnalysis(normalizedFixture(), "sample-key-moments-missing");
