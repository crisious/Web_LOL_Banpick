// server.js buildAnalysis combatAnalysis missing tracking regression tests
...
function normalizedFixture() {
  return {
    matchInfo: { matchId: "KR_COMBAT_MISSING", queueLabel: "RANKED_SOLO" },
    playerContext: { riotId: "Combat#KR1", participantId: 1 },
    timelineEvents: [],
    phaseContext: {},
    playerStats: {},
    teamContext: {},
...
const result = await buildAnalysis(normalizedFixture(), "sample-combat-missing");
