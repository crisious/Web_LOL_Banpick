...
```text
git commit -m "test: track short action checklists"
# [main 7c8d005] test: track short action checklists

git push origin main
# 233cabd..7c8d005 main -> main
```
...
```text
gh run watch 27180340483 --exit-status
# success

Artifact: qa-automation-27180340483
Artifact id: 7497273417
Commit: 7c8d005
...
rg -n --hidden -S "RGAPI|api_key|RIOT_API_KEY|Authorization|Bearer|kr\\.api\\.riotgames\\.com|americas\\.api\\.riotgames\\.com|/lol/|live Riot|sample generation" test-artifacts/tmp/gh-run-27180340483
# no matches
